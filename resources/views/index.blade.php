                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{route('singlepost',['slug'=>$firstpost->slug])}}">{{$firstpost->title}}</a>
                                    </h2>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="#">{{$third_post->category->name}}o</a>
                                        </span>
        ...
        <div class="row medium-padding120 bg-border-color">
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                          @foreach($js->posts()->orderBy('created_at','desc')->take(3)->get() as $javas)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{asset($javas->featured)}}" alt="our case">
                                    </div>
                                    <h6 class="case-item__title text-center"><a href="{{route('singlepost',['slug'=>$javas->slug])}}">{{$javas->title}}</a></h6>
                                </div>
                            </div>
                         @endforeach
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($laravel->posts()->orderBy('created_at','desc')->take(3)->get() as $laravels)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{$laravels->featured}}" alt="our case">
                                    </div>
                                    <h6 class="case-item__title"><a href="{{route('singlepost',['slug'=>$laravels->slug])}}">{{$laravels->title}}</a></h6>
                                </div>
                            </div>
                            @endforeach
